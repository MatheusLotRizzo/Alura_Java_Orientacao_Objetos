...
public class OrdenandoListas {
	...
	public static void main(String[] args) {
        ...
        cc4.deposita(222.0);
          ...
          //OrdenaTitular ordena = new OrdenaTitular();
	...
	class OrdenaNumConta implements Comparator<Conta>{
		...
		public int compare(Conta c1, Conta c2) {
			...
			/*return c1.getNumConta() - c2.getNumConta();*/
			
			/*if(c1.getNumConta() < c2.getNumConta()) {
				return -1;
			}
			if(c1.getNumConta() > c2.getNumConta()) {
				return 1;
